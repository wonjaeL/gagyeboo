...
public class LoginServiceImpl implements LoginService {
	...
	public String saveRegisterInfo(RegistDto mbr) throws Exception {
		String emailRegExp = "^[_A-Za-z0-9-\\+]+(\\.[_A-Za-z0-9-]+)*@"
		...
		try {
			String htmlStr = "<h2>" + members.getLastName() + members.getFirstName() + "님 안녕하세요.</h2>"
					...
					+ "<a href='http://localhost:8080/login/certification.do?userNo=" + members.getUserNo() + "&userId="
					+ members.getUserId() + "&userKey=18f198e0-92a9-447c-9adf-b93b4b578644'>[인증하기]</a></p>"
					+ "(혹시 잘못 전달된 메일이라면 이 이메일을 무시하셔도 됩니다)</h3>";

			MailHandler mail = new MailHandler(emailSender);
			mail.setFrom("dnjswo0926@gmail.com", "인하대학교");
	...
	@Override
	public List<MembersDto> selectAllMembers() throws Exception {
		return loginMapper.selectAllMembers();
	}
}
